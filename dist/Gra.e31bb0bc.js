...
},{}],"views/gameView.js":[function(require,module,exports) {
"use strict";
...
var gameView = /*#__PURE__*/function () {
  ...
  _createClass(gameView, [{
    ...
    value: function showEndMessage() {
      this._infoDiv.classList.add("info__message");
    ...
    value: function showWelcomeMessage() {
      // this._infoDiv.classList.remove("info__message");
      this._infoDiv.innerHTML = "Kliknij w <span class=\"info--color\">zielony </span>kwadrat, aby zdoby\u0107 punkt.";
    }
  }]);
...
},{}],"views/headerView.js":[function(require,module,exports) {
"use strict";
...
exports.drawNumber = exports.DRAW_INTERVAL = exports.DELAY = exports.HOW_MANY_SQUARES = void 0;
...
var _gameView = _interopRequireDefault(require("./views/gameView.js"));
...
var drawGreenSquare = function drawGreenSquare() {
  ...
  var greenNumber = (0, _helpers.drawNumber)(_helpers.HOW_MANY_SQUARES);
  setTimeout(removeActiveClass, _helpers.DELAY, greenNumber);
...
var isEndOfGame = function isEndOfGame() {
  var _model$state = model.state,
      ...
      time = _model$state.time; // return lives == 0 || play == false || time == 0 ? true : false;

  if (lives == 0 || play == false || time == 0) {
    _gameView.default.showEndMessage();
...
var startGame = function startGame() {
  ...
  model.startGame();
  startTimer();
  drawIntervalId = setInterval(drawGreenSquare, _helpers.DRAW_INTERVAL);
};
...
_gameView.default.showSquares(_helpers.HOW_MANY_SQUARES);
},{"./model.js":"model.js","./views/gameView.js":"views/gameView.js","./views/headerView.js":"views/headerView.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./helpers":"helpers.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Gra.e31bb0bc.js.map